...
`,[S("splitor",`
 ...
 `)])]);function mo(o,a,e){var i;const n=[];let p=!1;for(let t=0;t<o.length;++t){const d=o[t],s=(i=d.type)===null||i===void 0?void 0:i.name;s==="RadioButton"&&(p=!0);const g=d.props;if(s!=="RadioButton"){n.push(d);continue}if(t===0)n.push(d);else{const h=n[n.length-1].props,m=a===h.value,b=h.disabled,x=a===g.value,f=g.disabled,C=(m?2:0)+(b?0:1),w=(x?2:0)+(f?0:1),y={[`${e}-radio-group__splitor--disabled`]:b,[`${e}-radio-group__splitor--checked`]:m},r={[`${e}-radio-group__splitor--disabled`]:f,[`${e}-radio-group__splitor--checked`]:x},l=C<w?r:y;n.push(O("div",{class:[`${e}-radio-group__splitor`,l]}),d)}}return{children:n,isButtonGroup:p}}const xo=Object.assign(Object.assign({},V.props),{name:String,value:[String,Number,Boolean],defaultValue:{type:[String,Number,Boolean],default:null},size:String,disabled:{type:Boolean,default:void 0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]}),Co=lo({name:"RadioGroup",props:xo,setup(o){const a=R(null),{mergedSizeRef:e,mergedDisabledRef:i,nTriggerFormChange:n,nTriggerFormInput:p,nTriggerFormBlur:t,nTriggerFormFocus:d}=_(o),{mergedClsPrefixRef:s,inlineThemeDisabled:g,mergedRtlRef:h}=A(o),m=V("Radio","-radio-group",fo,j,o,s),b=R(o.defaultValue),x=T(o,"value"),f=P(x,b);function C(u){const{onUpdateValue:v,"onUpdate:value":k}=o;v&&B(v,u),k&&B(k,u),b.value=u,n(),p()}function w(u){const{value:v}=a;v&&(v.contains(u.relatedTarget)||d())}function y(u){const{value:v}=a;v&&(v.contains(u.relatedTarget)||t())}uo(E,{mergedClsPrefixRef:s,nameRef:T(o,"name"),valueRef:f,disabledRef:i,mergedSizeRef:e,doUpdateValue:C});const r=ao("Radio",h,s),l=L(()=>{const{value:u}=e,{common:{cubicBezierEaseInOut:v},self:{buttonBorderColor:k,buttonBorderColorActive:M,buttonBorderRadius:N,buttonBoxShadow:G,buttonBoxShadowFocus:J,buttonBoxShadowHover:W,buttonColor:Z,buttonColorActive:q,buttonTextColor:K,buttonTextColorActive:Q,buttonTextColorHover:X,opacityDisabled:Y,[U("buttonHeight",u)]:oo,[U("fontSize",u)]:eo}}=m.value;return{"--n-font-size":eo,"--n-bezier":v,"--n-button-border-color":k,"--n-button-border-color-active":M,"--n-button-border-radius":N,"--n-button-box-shadow":G,"--n-button-box-shadow-focus":J,"--n-button-box-shadow-hover":W,"--n-button-color":Z,"--n-button-color-active":q,"--n-button-text-color":K,"--n-button-text-color-hover":X,"--n-button-text-color-active":Q,"--n-height":oo,"--n-opacity-disabled":Y}}),c=g?no("radio-group",L(()=>e.value[0]),l,o):void 0;return{selfElRef:a,rtlEnabled:r,mergedClsPrefix:s,mergedValue:f,handleFocusout:y,handleFocusin:w,cssVars:g?void 0:l,themeClass:c==null?void 0:c.themeClass,onRender:c==null?void 0:c.onRender}},render(){var o;const{mergedValue:a,mergedClsPrefix:e,handleFocusin:i,handleFocusout:n}=this,{children:p,isButtonGroup:t}=mo(so(bo(this)),a,e);return(o=this.onRender)===null||o===void 0||o.call(this),O("div",{onFocusin:i,onFocusout:n,ref:"selfElRef",class:[`${e}-radio-group`,this.rtlEnabled&&`${e}-radio-group--rtl`,this.themeClass,t&&`${e}-radio-group--button-group`],style:this.cssVars},p)}});export{Co as N,vo as a,j as r,go as s};
