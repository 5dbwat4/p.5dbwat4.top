...
`,[i("input, textarea",`
 ...
 `),C("&:-webkit-autofill ~",[i("placeholder","display: none;")])]),z("round",[j("textarea","border-radius: calc(var(--n-height) / 2);")]),i("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
