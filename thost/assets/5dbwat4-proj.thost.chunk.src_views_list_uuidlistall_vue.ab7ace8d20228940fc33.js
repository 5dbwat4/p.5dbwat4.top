...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"API\": () => (/* binding */ API)\n/* harmony export */ });\nconst API={\r\n    get:async(url)=>{\r\n        console.log(await fetch(localStorage.getItem(\"__5dbwat_proj__thost_apihost\")+url).then(v.json()));\r\n        return await fetch(localStorage.getItem(\"__5dbwat_proj__thost_apihost\")+url).then(v.json())\r\n    },\r\n    post:async(url,body)=>{\r\n        return await fetch(localStorage.getItem(\"__5dbwat_proj__thost_apihost\")+url,{\"method\":\"POST\",\"body\":JSON.stringify(body),\"headers\":{\"Content-Type\":\"application/json\"}}).then(v.json())\r\n    }\r\n}\r\n\r\n\n\n//# sourceURL=webpack:///./src/shared/APIHelper.js?");
