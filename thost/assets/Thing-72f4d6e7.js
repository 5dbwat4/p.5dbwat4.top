import{c as _,m as f,h as v,a as n,b,i as s,q as B,r as H,u as z,o as w,d as x,e as S,g as I,t as M}from"./light-3c431b54.js";import{v as $,aa as L,b3 as F,i as y,J as o,O as W,F as V}from"./index-c2ed52a5.js";const q=r=>{const{textColor2:e,cardColor:i,modalColor:l,popoverColor:c,dividerColor:h,borderRadius:p,fontSize:d,hoverColor:a}=r;return{textColor:e,color:i,colorHover:a,colorModal:l,colorHoverModal:f(l,a),colorPopover:c,colorHoverPopover:f(c,a),borderColor:h,borderColorModal:f(l,h),borderColorPopover:f(c,h),borderRadius:p,fontSize:d}},J={name:"List",common:_,self:q},N=J,A=r=>{const{textColor1:e,textColor2:i,fontWeightStrong:l,fontSize:c}=r;return{fontSize:c,titleTextColor:e,textColor:i,titleFontWeight:l}},G={name:"Thing",common:_,self:A},K=G,Q=v([n("list",`
