import{a as V,s as Do,h as f,v as Fo,m as lo,g as Eo,c as Io,b as F,i as x,j as io,d as ao,u as Bo,o as Go,k as t,n as A,e as Wo}from"./light-3c431b54.js";import{i as ko,u as Ro,c as co,a as Oo,N as Mo}from"./Loading-b36f50c8.js";import{u as jo,r as uo,i as Lo}from"./use-memo-13475312.js";import{v as bo,b3 as _o,aZ as L,_ as No,X as Qo,J as D,O as Ko,i as J}from"./index-c2ed52a5.js";import{N as qo}from"./FadeInExpandTransition-3bfdffc9.js";import{c as Vo}from"./use-is-mounted-912be460.js";const _=typeof document<"u"&&typeof window<"u",Ao=V("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`),Jo=bo({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(r){Do("-base-wave",Ao,_o(r,"clsPrefix"));const C=L(null),g=L(!1);let p=null;return No(()=>{p!==null&&window.clearTimeout(p)}),{active:g,selfRef:C,play(){p!==null&&(window.clearTimeout(p),g.value=!1,p=null),Qo(()=>{var y;(y=C.value)===null||y===void 0||y.offsetHeight,g.value=!0,p=window.setTimeout(()=>{g.value=!1,p=null},1e3)})}}},render(){const{clsPrefix:r}=this;return D("div",{ref:"selfRef","aria-hidden":!0,class:[`${r}-base-wave`,this.active&&`${r}-base-wave--active`]})}}),{cubicBezierEaseInOut:G}=Fo;function Xo({duration:r=".2s",delay:C=".1s"}={}){return[f("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),f("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 opacity: 0!important;
 ...
 align-items: center;
 justify-content: center;
 `,[ko({top:"50%",originalTransform:"translateY(-50%)"})]),Xo()]),x("content",`
 display: flex;
 align-items: center;
 flex-wrap: nowrap;
 min-width: 0;
