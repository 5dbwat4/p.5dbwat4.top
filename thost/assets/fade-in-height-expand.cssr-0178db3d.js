import{h as n,v as m}from"./light-3c431b54.js";const{cubicBezierEaseInOut:a,cubicBezierEaseOut:c,cubicBezierEaseIn:h}=m;function f({overflow:$="hidden",duration:i=".3s",originalTransition:t="",leavingDelay:o="0s",foldPadding:d=!1,enterToProps:s=void 0,leaveToProps:g=void 0,reverse:p=!1}={}){const e=p?"leave":"enter",r=p?"enter":"leave";return[n(`&.fade-in-height-expand-transition-${r}-from,
